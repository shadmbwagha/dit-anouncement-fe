<template>
    <div class="relative m-10 bg-white border border-4 rounded-lg shadow">
            ...
            <form action="#">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="product-details" rows="6" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-sm focus:ring-cyan-600 focus:border-cyan-600" placeholder="Details"></textarea>
                    </div>
                </div>
            </form>
        </div>
